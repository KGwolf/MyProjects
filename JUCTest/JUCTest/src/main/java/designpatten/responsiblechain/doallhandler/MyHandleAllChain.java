 ...
 * @Version: V1.0
 */
public class MyHandleAllChain {
    //通过组合一个链表

    /**
     * 头结点
     */
    private MyChainAllAbstract head;
    /**
     * 尾结点
     */
    private MyChainAllAbstract tail;

    public void addHandler(MyChainAllAbstract handler){
