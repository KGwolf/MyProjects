...
INSERT INTO `leaf_alloc` VALUES ('leaf-segment-test',10001,2000,'Test leaf Segment Mode Get Id','2022-06-29 14:00:52'),('order_id',52,3,'订单id','2025-03-27 07:05:12'),('order_item_id',95000,2000,'订单详情项ID','2022-10-11 09:09:42'),('pr_task_id',41,10,'pr审查的taskid','2025-03-28 09:24:04');
/*!40000 ALTER TABLE `leaf_alloc` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'leaf'
--
...
-- Dump completed on 2025-03-28 20:24:52
