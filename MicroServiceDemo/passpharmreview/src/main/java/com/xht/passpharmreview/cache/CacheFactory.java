...
public class CacheFactory<K, V> {
     ...
     * @return
     */
    public MapCacheBaseT<K, V> createMultiLevelWriteCacheWithDelayDoubleDelete(CacheBase<K, V> localCache, CacheBase<K, V> remoteCache, Consumer<Map<K,V>> putManyFunc) {
